...
object AppModule {
    ...
    @Provides
    @PlainMainService
    fun providePlainMainService(@PlainRetrofit retrofit: Retrofit): MainService {
        return retrofit.create(MainService::class.java)
    }
    ...
    @Provides
    @PlainMainRepository
    fun providePlainMainRepository(@PlainMainService mainService: MainService): MainRepository {
        return DefaultMainRepository(mainService)
    }
        ...
        override fun intercept(chain: Interceptor.Chain): Response = with(chain) {
            ...
            if (response.code == 401) {
                synchronized(this) {
                    ...
                    runBlocking {
                        val responseResult =
                            mainRepository.getAccessToken(MemberSelectRequest(memberId))
...
@Qualifier
@Retention(AnnotationRetention.RUNTIME)
annotation class PlainMainService

@Qualifier
@Retention(AnnotationRetention.RUNTIME)
annotation class PlainMainRepository